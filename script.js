...
function adicionarMateria() {
    ...
    novaMateria.innerHTML = `
        ...
        <div class="notas">
            ...
            <input type="number" name="materia${materiasAdicionadas}_nota3" placeholder="AF" min="0" step="0.01" required aria-label="Nota PA">
...
function irPara(universidade) {
      // Redireciona para a calculadora da universidade
      window.location.href = `calculadora_${universidade}.html`;
}
